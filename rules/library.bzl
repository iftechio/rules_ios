...
def apple_library(name, library_tools = {}, export_private_headers = True, namespace_is_module_name = True, default_xcconfig_name = None, xcconfig = {}, xcconfig_by_build_setting = {}, **kwargs):
    ...
    # rules.
    print(name, header_namespace, objc_hdrs)
    headermap(
    ...
    project_hmap_name = name + "_project_hmap"
    ...
    private_deps.append(project_hmap_name)
    ...
    _append_headermap_copts(project_hmap_name, "-I", additional_objc_copts, additional_swift_copts, additional_cc_copts)
